...
openai.api_key = "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"

LWFGen = "The little white fox NPC is a genetically modified product of Evo-G Corporation, capable of transforming into a fox or a human with fox ears and tail. It has white fur and hair, and resembles a 14-year-old girl."
...
LWFCur = "The little white fox and Fiona transform into humans to welcome the player home."
...
def createSummary():
    global LWFGen,LWFCap,LWFPer,LWFMem,LWFCur,LWFEnv,usrHistory
   ...
   # if "player: " was found, remove everything before it
    if last_player_index != -1:
       usrHistory = usrHistory[last_player_index + len(playerName+": "):]
